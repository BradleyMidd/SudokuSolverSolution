    ...
    class NakedPairsStrategy : ISudokuStrategy
    {
        ...
        public int[,] Solve(int[,] sudokuBoard)
        {
            for (int row = 0; row < sudokuBoard.GetLength(0); row++)
            {
                ...
                {
                    EliminateeNakedPairFromOthersInRow(sudokuBoard, row, col);
                    EliminateeNakedPairFromOthersInCol(sudokuBoard, row, col);
                    EliminateeNakedPairFromOthersInBlock(sudokuBoard, row, col);
                }

            }
            return sudokuBoard;
        }
        private void EliminateeNakedPairFromOthersInRow(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminateeNakedPairFromOthersInCol(int[,] sudokuBoard, int givenRow, int givenCol)
        {
        ...
        private void EliminateeNakedPairFromOthersInBlock(int[,] sudokuBoard, int givenRow, int givenCol)
        {
